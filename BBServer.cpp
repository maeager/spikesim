...
#if debug
std::cout << "handle POST_TODO from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
...
#if debug
std::cout << "handle POST_RESULT " << index << " from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
...
#if debug
std::cout << "handle POST " << key << " from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
	...
	case LOOK:
		key = BBS2MPI::getkey(recv);
#if debug
std::cout << "handle LOOK " << key << " from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
	...
	case LOOK_TAKE:
		key = BBS2MPI::getkey(recv);
#if debug
		std::cout << "handle LOOK_TAKE " << key << " from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
...
std::cout << "handle sending back something" << std::endl;
	...
	case TAKE:
		key = BBS2MPI::getkey(recv);
#if debug
std::cout << "handle TAKE " << key << " from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
		if (BBSDirectServer::server_->look_take(key, &send)) {
#if debug
std::cout << "handle sending back something" << std::endl;
...
std::cout << "handle add_looking_todo" << std::endl;
	...
	case HELLO:
#if debug
std::cout << "handle HELLO from " << cid << " when cross=" << hoc_cross_x_ << std::endl;
#endif
