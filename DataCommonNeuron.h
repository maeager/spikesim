...
protected:
	...
	const ListPostSynType & list_postsynapses_impl() const {return list_postsynapses_;} // list of postsynapses
private:
...
public:
	...
	void reset() {postsyn_list_pointer_ = 0;}
	void visit(DataCommonNeuron & dcn) {postsyn_list_pointer_ = & dcn.list_postsynapses_;}
	ListPostSynType * const postsyn_list_pointer() const {return postsyn_list_pointer_;}
protected:
