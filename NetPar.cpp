...
/** 
 * Run the spike exchange routine with additional compression
 * 
 */
...
/** 
 * Clear the gid2in and gid2out lists
 * 
 */
...
/** 
 * Does the neuron exist on this node
 * 
 * @param gid 
 * 
 * @return 
...
/** 
 * Set the gid on the pre-synaptic pointer
 * 
 * @param gid 
 */
