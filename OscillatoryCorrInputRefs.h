...
//	OscillatoryDeltaCorrInputRef(double base_rate, double oscil_freq, double oscil_amplitude, double correlation);
	...
	inline const double & rate_when_not_correlated() const {return effective_correl_rate_;}
	inline const double & rate_when_correlated() const {return effective_correl_rate_;}
	inline const bool & correlated_event_state() const {return correlated_event_state_;}
private:
	void input_update();
	double base_rate_;
