...
public:
	...
	//!
	static inline void advance() {++i_time_; sim_time_ += timestep_;}
...
//	static inline void activation_update() {net_.update();}
	...
	static inline const Time & timestep() {return timestep_;}
	static inline const DiscreteTime & i_duration() {return i_duration_;}
	static inline const unsigned & i_max_delay() {return i_max_delay_;}
	static inline const DiscreteTime & i_time() {return i_time_;}
	static inline const Time & sim_time() {return sim_time_;}
	static inline const Time & plasticity_effective_start_time() {return plasticity_effective_start_time_;}
	
	static const long & random_init_seed() {return random_init_seed_;}
	static const bool & reinit_random_before_sim() {return reinit_random_before_sim_;}
